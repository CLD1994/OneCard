...
/**
 * 拷贝自Facebook
 * Modify by cld on 2016/7/27 上午 10:33.
 */
public final class Preconditions {
  ...
  public static <T extends CharSequence> T checkNotEmpty(T text) {
    return checkNotEmpty(text,
            "[Assertion failed] - this string must not be null or empty.");
  }

  public static <T extends CharSequence> T checkNotEmpty(T text, String message) {
